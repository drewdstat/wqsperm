...
#' of the Weighted Quantile Sum (WQS) method followed by the permutation test to 
#' determine the significance of the WQS coefficient. 
#' 
...
#' WQS run and not the permutation test iterations. 
...
#' permutation test if the main WQS run produces nonsignificant p-value.
