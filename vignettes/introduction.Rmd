...
we are training our model on only part of the data. However, if we skip this 
...
full dataset for training and validation, and we subsequently apply a permutation 
test to estimate the uncertainty:
