...
* **Linear regression only:** The permutation test algorithm can only have `gwqs` inputs where `family = gaussian` and `link = identity`. A logistic regression version for the algorithm is currently in the works. 
